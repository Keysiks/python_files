...
class Game_form(QMainWindow):
    def __init__(self, parent):
        ...
        self.setWindowTitle("Тестовая форма")
        ...
        try:
            if end:
                ...
                if letter_text == letter_area_for_typing:
                    ...
                    self.format.setTextOutline(QPen(QColor("blue")))
    ...
    def end(self):
        ...
        self.accuracy = round((self.symbols_count - self.wrong_symbols) / self.symbols_count,
                              2) * 100 if self.symbols_count - self.wrong_symbols > 0 else 0
        self.time_count = 0
        self.symbols_count = 0
        self.wrong_symbols = 0
